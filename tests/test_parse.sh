...
assert_contains "$out" "[P0]"  "list: item one prio"
assert_contains "$out" "one"   "list: item one description"
assert_contains "$out" "~[#"   "list: item two is triaging"
assert_contains "$out" "[P1]"  "list: item two prio"
assert_contains "$out" "two"   "list: item two description"
assert_contains "$out" "+[#"   "list: item three is done"
assert_contains "$out" "[P3]"  "list: item three prio"
